# Code of conduct for `dhsc-hack`

Contributors to this repository hosted by `i-dot-ai` are expected to follow the
...
- "Project", we mean this `dhsc-hack` GitHub repository;
- "Maintainer", we mean the `i-dot-ai` organisation owners; and
- "Leadership", we mean both `i-dot-ai` organisation owners, line managers, and other
  leadership within the i.Ai.
...
[andreas.varotsis@cabinetoffice.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:andreas.varotsis@cabinetoffice.gov.uk
